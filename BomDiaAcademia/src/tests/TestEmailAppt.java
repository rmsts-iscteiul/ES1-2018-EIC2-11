...
class TestEmailApp {
	...
	void testWritePart() throws MessagingException, Exception {
		...
		System.out.println("From + Subjects:" + email.writeEnvelope(aux)); /** Returns the Subject and email who sent the message */
	}
	...
	void testSendEmail() {
		...
		System.out.println("Send an email to matiasfrazaocorreia@gmail.com with the text as 'test' and a file attached:");
